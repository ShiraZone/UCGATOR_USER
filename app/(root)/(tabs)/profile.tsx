...
// components
import { ScrollView, StyleSheet, Text, TouchableOpacity, View, ImageBackground, StatusBar } from 'react-native';
            ...
            <ImageBackground style={{ minHeight: 'auto', maxHeight: 175, height: 175, padding: 15 }} source={IMAGES.menu_image_cover}>
                ...
                <View style={{ width: '100%', paddingVertical: 12, paddingHorizontal: 8, flexDirection: 'row', alignItems: 'center', marginBottom: 50 }}>
                    ...
                    <View style={{ flexDirection: 'column', gap: 2 }}>
                        <Text style={{ fontSize: 20, fontFamily: 'Montserrat-Bold', textAlign: 'center', color: COLORS.pmy.white }}>Charles Peter L. Tigoy</Text>
                        <Text style={{ fontSize: 14, fontFamily: 'Montserrat-Light', color: COLORS.pmy.white }}>tigoy.petercharles@gmail.com</Text>
                    </View>
